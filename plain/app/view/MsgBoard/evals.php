...
<div class="msg_board_eval_w">
    ...
    foreach($evalData as $evalEnt){
    	...
    	<div class="msg_board_eval_div" style="margin-right:1.2em;">
    		<button type="button" class="eval_btn_base <?php echo $pushed_class; ?>" onclick="evaluateForMsgBoard(this)" data-msg-board-id = "<?php echo $msg_board_id; ?>" data-eval-type-id = "<?php echo $eval_type_id; ?>" style="mask-image: url(<?php echo $icon_fn; ?>);-webkit-mask-image: url(<?php echo $icon_fn; ?>"></button>
