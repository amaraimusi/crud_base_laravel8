 ...
 * @license MIT
 * @author k-uehara 
 */var ClmShowHide=function(){var t=this;function e(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var s in t.defClmData){var n=t.defClmData[s].show_flg,l=r.find("[index="+s+"]");l[0]&&(1==n?(l.prop("checked",!0),t.clm_show_csh(e,s)):0==n&&(l.prop("checked",!1),t.clm_hide_csh(e,s)))}localStorage.removeItem(a+"_clmData")}function i(){var e=jQuery("#"+t.props.chBoxsId),i=t.actClmData;for(var a in i){var r=e.find("[index="+a+"]");if(r[0]){var s=r.prop("checked");i[a].show_flg=1==s?1:0}}return i}this.props={},this.defClmData={},this.actClmData={},this.init=function(a,r,s,n){this.props.tblId=a,this.props.chBoxsId=r,this.props.unique=n,null==n&&(n=a);for(var l=[],o=0;o<s.length;o++){var h={clm_name:null,show_flg:s[o]};l[o]=h}o=0;$.each(jQuery("#"+a+" thead tr th"),(function(){var t=jQuery(this).html();try{l[o].clm_name=t}catch(t){return}o++}));var d=localStorage.getItem(n+"_clmData"),_={};for(var o in _=""==d||null==d?$.extend(!0,{},l):JSON.parse(d),this.defClmData=l,this.actClmData=_,_=function(t){for(let e in t){let i=t[e],a=i.clm_name;null==a&&(a=""),i.clm_name=a.replace(/<("[^"]*"|'[^']*'|[^'">])*>/g,"")}return t}(_),function(t,e,i){var a=jQuery("#"+e);for(var r in a.empty(),i){var s=i[r];if(-1==s.show_flg)continue;var n="";1==s.show_flg&&(n="checked");let t="csh_cb"+r;var l="<div class='csh_cb_div'><input id='"+t+"' type='checkbox' class='csh_cb' "+n+" index='"+r+"' /><label for='"+t+"'>"+s.clm_name+"</label></div>";a.append(l)}a.append("<div style='clear:both'></div>");var o="<div class='csh_func_btn'><input type='button' value='列表示を保存' id='"+t+"_save_btn' class='btn btn-primary btn-sm' /></div>";a.append(o);var h="<div class='csh_func_btn'><input type='button' value='すべてチェック' id='"+t+"_all_checked_btn' class='btn btn-primary btn-sm' /></div>";a.append(h);var d="<div class='csh_func_btn'><input type='button' value='すべてはずす' id='"+t+"_all_uncheck_btn' class='btn btn-primary btn-sm' /></div>";a.append(d);var _="<div class='csh_func_btn'><input type='button' value='初期に戻す' id='"+t+"_default_btn' class='btn btn-primary btn-sm' /></div>";a.append(_),a.append("<div id='csh_msg' class='csh_func_btn' style='display:none;color:#de5246'>列の表示状態を記憶しました。</div>")}(a,r,_),jQuery(".csh_cb").click((function(e){var i=jQuery(this).prop("checked"),r=jQuery(this).attr("index");1==i?t.clm_show_csh(a,r):t.clm_hide_csh(a,r)})),_){0==(h=_[o]).show_flg&&this.clm_hide_csh(a,o)}jQuery("#"+a+"_save_btn").click((function(t){!function(t,e,a){var r=i(),s=JSON.stringify(r);localStorage.setItem(a+"_clmData",s),jQuery("#csh_msg").show(),jQuery("#csh_msg").fadeOut(3e3)}(0,0,n)})),jQuery("#"+a+"_all_checked_btn").click((function(e){!function(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var s in a){var n=r.find("[index="+s+"]");if(n[0])0==n.prop("checked")&&(n.prop("checked",!0),t.clm_show_csh(e,s))}}(a,0,t.actClmData)})),jQuery("#"+a+"_all_uncheck_btn").click((function(e){!function(e,i,a){var r=jQuery("#"+t.props.chBoxsId);for(var s in a){var n=r.find("[index="+s+"]");if(n[0])1==n.prop("checked")&&(n.prop("checked",!1),t.clm_hide_csh(e,s))}}(a,0,t.actClmData)})),jQuery("#"+a+"_default_btn").click((function(t){e(a,r,n)}))},this.getCshAry=function(){var e=jQuery("#"+t.props.chBoxsId),i=[];for(var a in this.defClmData){var r=e.find("[index="+a+"]");if(r[0])1==r.prop("checked")?i.push(1):i.push(0)}return i},this.reset=function(){e(this.props.tblId,this.props.chBoxsId,this.props.unique)},this.refresh=function(){var t=this.props.tblId;for(var e in this.defClmData)this.clm_show_csh(t,e);var a=i();for(var e in a){var r=a[e].show_flg;1==r?this.clm_show_csh(t,e):0==r&&this.clm_hide_csh(t,e)}},this.clm_show_csh=function(t,e){jQuery("#"+t+" thead tr th").eq(e).show(),$.each(jQuery("#"+t+" tbody tr"),(function(){jQuery(this).children().eq(e).show()}))},this.clm_hide_csh=function(t,e){jQuery("#"+t+" thead tr th").eq(e).hide(),$.each(jQuery("#"+t+" tbody tr"),(function(){jQuery(this).children().eq(e).hide()}))}};
/**
 ...
 * @license MIT
 * @auther amaraimusi
 */class StaticPaginationB4{pagenation(t,e){null==e&&(e={}),null==e.visible_row_count&&(e.visible_row_count=8),null==e.cur_page_num&&(e.cur_page_num=0),null==e.pn_position&&(e.pn_position="bottom"),e.xid=t;let i=e.visible_row_count,a=(e.pn_position,jQuery("#"+t)),r=a.find("tbody tr"),s=r.length;if(0==s)return;e.num_rows=s,e.all_page_count=Math.ceil(s/i),"last"==e.cur_page_num&&(e.cur_page_num=e.all_page_count-1);let n=e.cur_page_num;this._applyToTable(r,n,i);let l=this._createPagenationHtml(e);a.after(l),this._bindClickPagenation(e),this.param=e,this.trs=r}_applyToTable(t,e,i){t.hide().slice(e*i,(e+1)*i).show()}_createPagenationHtml(t){let e="";for(let i=0;i<t.all_page_count;i++){let a="";i==t.cur_page_num&&(a="active"),e+=`<li class="page-item ${a}"><span class="page-link">${i+1}</span></li>`}return`<ul id="${t.xid}_pagenation" class="pagination">${e}</ul>`}_bindClickPagenation(t){let e=jQuery(`#${t.xid}_pagenation li`);this.pgItems=e,e.each(((t,e)=>{jQuery(e).click((e=>{this.pgItems.removeClass("active");let i=this.param.cur_page_num,a=this.param.visible_row_count;i=t,this._applyToTable(this.trs,i,a),this.param.cur_page_num=i,$(e.currentTarget).addClass("active")}))}))}}