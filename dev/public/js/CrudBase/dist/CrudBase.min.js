 ...
 * @auther amaraimusi
 * @license MIT
 */class PopupCat{popupize(t,e){this.popupElm=jQuery("#"+t),null==e&&(e={}),null==e.direction_type&&(e.direction_type="right_bottom"),null==e.z_index&&(e.z_index="2"),null==e.fadein_time&&(e.fadein_time=1e3),null==e.set_timeout_time&&(e.set_timeout_time=1500),this.popupClickCallback=e.popupClickCallback;let i="0px",a="0px",r="0px",s="0px";switch(e.direction_type){case"left_top":r="auto",s="auto";break;case"right_top":i="auto",s="auto";break;case"left_bottom":r="auto",a="auto";break;case"right_bottom":i="auto",a="auto";break;default:throw Error("PopupCat Error PCAT220129A")}this.popupElm.css({display:"none",position:"fixed",left:i,top:a,right:r,bottom:s,"z-index":e.z_index}),this.after_cb_flg=!1,this.popupElm.click((t=>{let e=$(t.currentTarget);console.log("閉じられたクリック"),this.popupClickCallback&&this.popupClickCallback(),e.hide()})),this.param=e}getPopupElm(){return this.popupElm}pop(t){this.afterCallback=t,this.after_cb_flg=!1,this.popupElm.hide(),this.popupElm.fadeIn(this.param.fadein_time,(()=>{window.setTimeout((()=>{this.popupElm.hide(),this.afterCallback&&this.afterCallback()}),this.param.set_timeout_time)}))}}
/**
 * 時間差ポップアップ
 * @note 
